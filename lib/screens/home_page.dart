        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromRGBO(36, 30, 32, 1),
              ...
              child: Stack(
                children: [
                  Positioned(
                    ...
                    left: 20,
                    child: Container(
                      width: 50, // Diameter of the CircleAvatar (radius * 2)
                      height: 50,
                      decoration: const BoxDecoration(
                        shape: BoxShape.circle,
                        image: DecorationImage(
                          image: AssetImage(
                              ubbus), // Provide the path to your image
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
          ...
          InkWell(
            ...
            child: buildCustomButton(
              ...
              title: 'Автобусны чиглэл хайх',
              subtitle: 'Автобусыг явах чиглэлийн дагуу хайх бол энд дарна уу',
            ),
          ),
          ...
          InkWell(
            ...
            child: buildCustomButton(
              icon: Icons.directions_bus,
              title: 'Автобусны буудал хайх',
              subtitle: 'Автобусны буудал хайх бол энд дарна уу',
            ),
          ),
        ],
      ),
